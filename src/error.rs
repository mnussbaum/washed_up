...
impl<'a> WashedUpError<'a> {
    pub fn description(&self) -> &str {
        match *self {
            ...
            WashedUpError::CorosError(ref err) => err.description(),
...
impl<'a> Error for WashedUpError<'a> {
    ...
    fn cause(&self) -> Option<&Error> {
        match *self {
            ...
            WashedUpError::CorosError(ref err) => Some(err),
...
impl<'a> From<CorosError> for WashedUpError<'a> {
    fn from(err: CorosError) -> WashedUpError<'a> {
        WashedUpError::CorosError(err)
    }
}
